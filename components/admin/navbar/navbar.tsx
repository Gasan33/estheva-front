  ...
  return (
    <div className="bg-white border-b-[1px] w-full sticky h-32 lg:h-auto">
      <div className={styles.container}>
        <div className="flex">
          <Link href={'/'} >
            <Image src='/icons/darkLogo.svg' alt='Estheva Polyclinic' width={120} height={60} style={{ width: "auto" }} priority className='object-contain h-12' />
          </Link>
        </div>


        <div className={styles.menu}>
          <div className=' flex-row border border-solid rounded-lg hidden  lg:flex'>
