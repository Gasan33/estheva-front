    ...
    return (
        <div className='p-3 lg:p-5 rounded-[12px] border border-solid border-primaryColor mb-5 cursor-pointer'>
            <div className="flex items-center justify-between gap-5" onClick={toggelAccordion}>
                <h4 className="text-[16px] leading-7 lg:text-[22px] lg:leading-8 text-primaryColor">{item.question}</h4>
            ...
            {isOpen && <div className='mt-4'>
                <p className='text-[14px] leading-6 lg:text-[16px] lg:leading-7 font-[400] text-gray-950'>{item.content}</p>
            </div>}
        </div>
    )
}
