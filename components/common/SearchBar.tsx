        ...
        <div className="md:w-1/3">
            <div className="relative flex w-full flex-wrap items-stretch">
                ...
                <TERipple color='light'>
                    <button
                        className="relative z-[2] flex items-center rounded-r bg-teal-500 px-6 py-2.5 text-xs font-medium uppercase leading-tight text-white shadow-md transition duration-150 ease-in-out hover:bg-teal-700 hover:shadow-lg focus:bg-teal-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-teal-700 active:shadow-lg"
                        type="button"
                        id="button-addon1">
                        <svg
